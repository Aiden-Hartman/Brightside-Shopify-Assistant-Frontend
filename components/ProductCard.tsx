  ...
  return (
    <div className="flex items-center border rounded-lg overflow-hidden shadow-sm bg-white p-2 space-x-3 max-w-xs">
      ...
      <div className="flex flex-col flex-1 min-w-0">
        <h3 className="font-medium text-gray-800 text-sm truncate mb-1">{product.title}</h3>
        <span className="text-base font-semibold text-gray-900 mb-2">{product.formattedPrice}</span>
        <a
          href={product.link}
          target="_blank"
